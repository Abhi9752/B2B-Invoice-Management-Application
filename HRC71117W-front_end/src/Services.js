...
export const getData = async () => {
  let response = await axios.get(
    "http://localhost:8080/Data_Loading/DataLoading"
  );
...
export const addWinter = async ({
  ...
  let respone = await axios.get(
    "http://localhost:8080/Data_Loading/Add?" + data
  );
  return respone.data;
};
...
export const editWinter = async ({
  ...
  let data =
    ...
    sl_no;
  let respone = await axios.get(
    "http://localhost:8080/Data_Loading/Update?" + data,
    {}
  );
  return respone.data;
};
...
export const deleteWinter = async (props) =>
{
  ...
  // const delQry = "sl_no_arr=48574&sl_no_arr=48575";
   await axios.get(`http://localhost:8080/Data_Loading/DeleteRow?${delQry}`);
};
